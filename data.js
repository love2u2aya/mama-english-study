  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          "Oto is my son.",
          "Oto is my boss.（家では…そうかも）",
          "Oto is my sun.（太陽ではない）",
          "Oto is my sofa.（家具じゃない）",
        ],
        answer: 0,
      },
      {
        ...
        choices: [
          "Mana is my daughter.",
          "Mana is my water.（みずではない）",
          "Mana is my doctor.（まだ高校生）",
          "Mana is my manager.（マネージャーでもない）",
        ],
        answer: 0,
      },
      {
        ...
        choices: [
          ...
          "Yoko loves Aya's CPAP machine.（愛は夫にあげて）",
          "Yoko loves Aya... on payday.（給料日だけ）",
          "Yoko loves Aya like a hamburger.（食べないで）",
        ],
        answer: 0,
      },
      {
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          ...
          "Oto used to play the guitar, but now he plays the recorder.（小学生に逆戻り）",
          "Oto used to play the guitar, but now he plays games.（それは知ってる）",
          "Oto plays the guitar, the bass, and the drums at once.（タコか）",
        ],
        answer: 0,
      },
      {
        ...
        choices: [
          ...
          "Oto used to be a humanities student, but now he studies sleeping.（学問じゃない）",
          "Oto used to study science, but now he studies snacks.（食べてるだけ）",
          "Oto studies nothing, only games.（ごもっとも）",
        ],
        answer: 0,
      },
      {
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          ...
          "I love Aya only without the mask.（条件つき）",
          "I love Aya's high cholesterol.（それは愛さなくていい）",
          "I love Aya like a hamburger.（また食べてる）",
        ],
        answer: 0,
      },
      {
        ...
        choices: [
          ...
          "When Oto plays games all night, Yoko sells him.（売らないで）",
          "When Oto plays games all night, Yoko joins him.（一緒に夜更かし）",
          "When Oto plays games, Yoko becomes a boss.（ラスボス参戦）",
        ],
        answer: 0,
      },
      {
      ...
      },
      {
        ...
        choices: [
          ...
          "There is a lot going on, so Yoko is hungry.（おなかすいた）",
          "There is a lot going on, so Yoko runs away.（逃げないで）",
          "There is a lot going on, but Yoko is a ninja.（また忍者）",
        ],
        answer: 0,
      },
    ],
