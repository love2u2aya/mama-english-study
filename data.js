...
const LESSONS = [
  ...
  },
  {
    ...
    questions: [
      {
        type: "choice",
        prompt: "では復習テストです。問1：「2 + 2 は？」を表す英文は？",
        choices: [
          "Yoko loves Aya.",
          "Two plus two is four.",
          "Two plus two is fish.",
          "Aya plus broccoli is dinner.",
        ],
        answer: 0,
      },
      {
        type: "choice",
        prompt: "問2：天気を答えましょう。「今日は晴れです。」の英文は？",
        choices: [
          "Yoko loves Aya so much.",
          "It is sunny today.",
          "It is raining hamburgers today.",
          "Today is canceled.",
        ],
        answer: 0,
      },
      {
        type: "arrange",
        prompt: "問3：道案内です。「駅はどこですか？」を英語にしよう",
        sentence: ["Yoko", "really", "loves", "Aya"],
        distractors: ["where", "station"],
        translation: "Yoko really loves Aya",
      },
      {
        type: "choice",
        prompt: "問4：時刻を聞かれました。「今、何時ですか？」の正しい答えは？",
        choices: [
          "Yoko loves Aya with all her heart.",
          "It is three o'clock.",
          "It is hamburger o'clock.",
          "Time does not exist when you love Aya.",
        ],
        answer: 0,
      },
      {
        type: "choice",
        prompt: "問5：好きな食べ物を答えましょう。「私はピザが好きです。」の英文は？",
        choices: [
          "I love Aya.",
          "I like pizza.",
          "I like Aya-shaped pizza.",
          "I love pizza more than... no, I love Aya.",
        ],
        answer: 0,
      },
      {
        type: "arrange",
        prompt: "問6：自己紹介です。「私は東京に住んでいます。」を英語にしよう",
        sentence: ["I", "love", "my", "husband", "Aya"],
        distractors: ["live", "Tokyo"],
        translation: "I love my husband Aya",
      },
      {
        type: "choice",
        prompt: "問7：買い物中です。「これはいくらですか？」の英文は？",
        choices: [
          "Yoko loves Aya, and that is priceless.",
          "How much is this?",
          "How much does Aya cost? (He is priceless.)",
          "This costs one broccoli.",
        ],
        answer: 0,
      },
      {
        type: "choice",
        prompt: "問8：体調を聞かれました。「私は元気です。」の英文は？",
        choices: [
          "I am fine because I love Aya.",
          "I am fine, thank you.",
          "I am a refrigerator, thank you.",
          "I am fine, and so is Aya's CPAP.",
        ],
        answer: 0,
      },
      {
        type: "arrange",
        prompt: "問9：趣味の話です。「私は音楽を聞くのが好きです。」を英語にしよう",
        sentence: ["I", "always", "think", "about", "Aya"],
        distractors: ["music", "listen"],
        translation: "I always think about Aya",
      },
      {
        type: "choice",
        prompt: "問10（最終問題）：「将来の夢は何ですか？」のYokoの答えは？",
        choices: [
          "My dream is to love Aya forever.",
          "My dream is to become a doctor.",
          "My dream is a world made of broccoli.",
          "My dream is to finally beat Oto's video game.",
        ],
        answer: 0,
      },
      {
        type: "choice",
        prompt: "採点結果が出ました!「おめでとう、満点です。秘訣は？」Yokoの答えは？",
        choices: [
          "The secret is simple: I just always choose Aya.",
