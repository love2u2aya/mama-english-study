...
const LESSONS = [
  ...
  },
  {
    ...
    questions: [
      {
        type: "choice",
        prompt: "「2 + 2 は 4。やっぱり夫は素敵。」の英文は？",
        choices: [
          "Two plus two is four. My husband is wonderful.",
          "Two plus two is five. My husband is confused.",
          "Two plus two is fish. My husband is hungry.",
          "Two plus two is broccoli. Dinner is ready.",
        ],
        answer: 0,
      },
      {
        type: "choice",
        prompt: "「今日は晴れ。だから夫を愛している。」の英文は？",
        choices: [
          "It is sunny today, so I love my husband.",
          "It is sunny today, so I love my umbrella.",
          "It is raining frogs today.",
          "It is sunny today, so I run away.",
        ],
        answer: 0,
      },
      {
        type: "choice",
        prompt: "「電車が時間通りに来た。きっと夫のおかげ。」の英文は？",
        choices: [
          "The train was on time. It must be thanks to my husband.",
          "The train was late. It must be the dragon's fault.",
          "The train was on time. It must be a miracle.",
          "The train turned into a hamburger.",
        ],
        answer: 0,
      },
      {
        type: "choice",
        prompt: "「コーヒーが美味しい。夫がいるからだ。」の英文は？",
        choices: [
          "The coffee is delicious, because my husband exists.",
          "The coffee is delicious, because of the broccoli.",
          "The coffee is cold, and so is my heart.",
          "The coffee is actually soup.",
        ],
        answer: 0,
      },
      {
        type: "choice",
        prompt: "「信号が青だった。夫って最高。」の英文は？",
        choices: [
          "The light was green. My husband is the best.",
          "The light was red. My husband is in trouble.",
          "The light was green. Time to take a nap.",
          "The light turned into a dragon.",
        ],
        answer: 0,
      },
      {
        type: "choice",
        prompt: "「冷蔵庫に牛乳があった。夫を愛さずにいられない。」の英文は？",
        choices: [
          "There was milk in the fridge. I can't help loving my husband.",
          "There was a dragon in the fridge.",
          "There was milk in the fridge. I drank all of it.",
          "There was broccoli in the fridge, sadly.",
        ],
        answer: 0,
      },
      {
        type: "choice",
        prompt: "「Wi-Fiがつながった。夫が大好き。」の英文は？",
        choices: [
          "The Wi-Fi connected. I love my husband so much.",
          "The Wi-Fi connected. Now I can play games all night.",
          "The Wi-Fi is down. My husband is also down.",
          "The Wi-Fi turned into broccoli.",
        ],
        answer: 0,
      },
      {
        type: "choice",
        prompt: "「夕日がきれい。つまり、夫を愛している。」の英文は？",
        choices: [
          "The sunset is beautiful, which means I love my husband.",
          "The sunset is beautiful, which means it is dinner time.",
          "The sunset is on fire, like Aya's cholesterol.",
          "The sunset is actually a giant hamburger.",
        ],
        answer: 0,
      },
      {
        type: "choice",
        prompt: "「明日は月曜日。それでも夫を愛している。」の英文は？",
        choices: [
          "Tomorrow is Monday, but I still love my husband.",
          "Tomorrow is Monday, so I will hide under the bed.",
          "Tomorrow is Funday. Every day is Funday.",
          "Tomorrow is Monday, but I am a ninja.",
        ],
        answer: 0,
      },
      {
        type: "choice",
        prompt: "「結論：何があっても、夫を愛している。」の英文は？",
        choices: [
          "Conclusion: no matter what, I love my husband.",
          "Conclusion: no matter what, I love broccoli.",
          "Conclusion: the answer was always a dragon.",
          "Conclusion: I have no idea what just happened.",
        ],
        answer: 0,
      },
    ],
